...
#pragma warning restore 0169
        ...
        private void UpdateAndSend(GrblCore Core)
        {
            ...
            bool mustsend = DateTime.UtcNow.Subtract(LastSent).TotalDays > 1 || Version != current || (Core.configuration.Version != null && GrblVersion != Core.configuration.Version);
            Version = current;
            GrblVersion = Core.configuration.Version != null ? Core.configuration.Version : GrblVersion;
            ...
            Wrapper = Setting.App.ComWrapperProtocol;

            Firmware fw = Setting.App.FirmwareType;
			FirmwareString = fw.ToString();
			VendorString = Setting.Grbl.Version != null ? Setting.Grbl.Version.Vendor : "Unknown";
