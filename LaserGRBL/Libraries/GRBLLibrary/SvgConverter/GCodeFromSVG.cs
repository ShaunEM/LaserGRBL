...
namespace LaserGRBL.SvgConverter
{
    public class GCodeFromSVG
	{
		...
		public bool SupportPWM = GlobalSettings.GetObject("Support Hardware PWM", true);
		public float gcodeSpindleSpeed = 999; // Spindle speed to apply
		public Firmware firmwareType = GlobalSettings.GetObject("Firmware Type", Firmware.Grbl);
		...
		private string gcodeSpindleCmdOn = GlobalSettings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOn", "M3"); // Spindle Command M3 / M4
		private string gcodeSpindleCmdOff = GlobalSettings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOff", "M5"); // Spindle Command M3 / M4
  ...
  //      {
		...
		public string ConvertFromSVG(XElement svgCode)
		{
			...
			setRapidNum(GlobalSettings.GetObject("Disable G0 fast skip", false) ? 1 : 0);
