...
//		public static bool SupportPWM = GlobalSettings.GetObject("Support Hardware PWM", true); 
//		public static float gcodeSpindleSpeed = 999; // Spindle speed to apply
//		public static Firmware firmwareType = GlobalSettings.GetObject("Firmware Type", Firmware.Grbl);
...
//		private static string gcodeSpindleCmdOn = GlobalSettings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOn", "M3"); // Spindle Command M3 / M4
//		private static string gcodeSpindleCmdOff = GlobalSettings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOff", "M5"); // Spindle Command M3 / M4
