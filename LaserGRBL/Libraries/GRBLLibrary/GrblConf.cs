...
namespace LaserGRBLPlus.Libraries.GRBLLibrary
{
	...
	public class GrblConf : IEnumerable<System.Collections.Generic.KeyValuePair<int, float>>
	{
		public class GrblConfParam : ICloneable
		{
			...
			public GrblConfParam(int number, float value)
		...
		private System.Collections.Generic.Dictionary<int, float> mData;
		...
		public GrblConf(GrblCore.GrblVersionInfo GrblVersion, System.Collections.Generic.Dictionary<int, float> configTable)
			: this(GrblVersion)
		{
			foreach (System.Collections.Generic.KeyValuePair<int, float> kvp in configTable)
		...
		public System.Collections.Generic.List<GrblConf.GrblConfParam> ToList()
		{
			...
			foreach (System.Collections.Generic.KeyValuePair<int, float> kvp in mData)
		...
		public System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<int, float>> GetEnumerator()
		{
